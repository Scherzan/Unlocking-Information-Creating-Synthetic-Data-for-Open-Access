...
data = [
    {
        "children": [
            ...
            {
                "children": [{"children": [{"name": """Choose a prediction
            ...
            },
            {
                "children": [
                    ...
                    {"children": [{"name": "Basic Statistical Properties"},
                     ...
                     "name": "TabSynDex \n"
                     "(Chundawat et al.)"},
                    {"children": [{"name": """Resemblance Analysis
                                   (URA, MRA, DRA, DLA)"""},
                                  {"name": """Utility Evaluation
                                   (classification)"""},
...
c = (
    Tree()
    .add("", data, label_opts=opts.LabelOpts(font_size=18, position='top',
                                             color='#1f449c'),
         initial_tree_depth=0, itemstyle_opts=opts.ItemStyleOpts(
