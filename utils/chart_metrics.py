        ...
        "children": [
            {
                "children": [
                    {
                        "children": [{"name": "Statistical Moments \n"
                                      "and Tests"},
            ...
            {
                "children": [{"children": [{"name": "Choose a prediction task within your data, \n"
            ...
            {
                "children": [
                    {"children": [{"name": "Paired Euclidean Distance"}, 
                                  {"name": "Wasserstein distance"}, 
                                  {"name": "Jensen-Shannon divergence"}], 
                    "name": "Similarity Evaluation Analysis (SEA)"},
                    {"children": [{"name": "Membership Inference Attack"},
            ...
            {
                "children": [
                    {"children": [{"name": "Basic Statistical Properties"}, 
...
c = (
    Tree()
    .add("", data, label_opts = opts.LabelOpts(font_size = 18, position = 'top', color='#1f449c'), 
         initial_tree_depth=0, itemstyle_opts = opts.ItemStyleOpts(border_color0 = "000000")) #
