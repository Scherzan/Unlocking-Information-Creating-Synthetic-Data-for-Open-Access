...
tab1, tab2, tab3, tab4 = st.tabs(["Our project learnings.💡",
                                  "So far so good. ✅",
                                  "Where to go next? 🧭",
                                  "Thank you. 💛"])
...
with tab1:
    ...
    if no_ds_team:
        ...
        """
        st.markdown(f'<p style="color:#1f449c">{text}</p>',
    ...
    if no_data_access:
        ...
        """
        st.markdown(f'<p style="color:#1f449c">{text_2}</p>',
                    unsafe_allow_html=True)
    ...
    if no_hardware:
        ...
        """
        st.markdown(f'<p style="color:#1f449c">{text_3}</p>',
                    unsafe_allow_html=True)
...
with tab2:
    ...
    if apply:
        ...
        st.markdown(f'<p style="color:#1f449c";><strong>{t_33}</strong></p>',
                    unsafe_allow_html=True)
...
with tab4: 
    st.markdown("""<h2 style='text-align: center; color:#1f449c;'>
                Happy Synthesizing 😃🧪</h2>""", unsafe_allow_html=True)
    st.write("")
    st.write("Find me on:")
